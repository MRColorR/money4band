#!/bin/bash
echo "First of all make sure that you have already run the runme.sh script and that you have registered to the various apps with the links provided and that you have already run the setup of the env file through the runme.sh script or done it manually."$'\n'
