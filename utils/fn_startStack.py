...
def start_all_stacks(main_compose_file: str = './docker-compose.yaml', main_env_file: str = './.env', main_instance_name: str = 'money4band', instances_dir: str = 'm4b_proxy_instances', skip_questions: bool = False, force_clean: bool = False) -> None:
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--force-clean', action='store_true',
                        help='Stop all containers before starting')
