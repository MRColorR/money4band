...
import json
import os
from utils.loader import load_json_config, load_module_from_file, load_modules_from_directory
...
class TestModuleLoader(unittest.TestCase):
    ...
    def test_load_module_from_file(self, mock_module_from_spec, mock_spec_from_file_location):
        """
    ...
    @patch('os.listdir', return_value=['module1.py', 'module2.py', '__init__.py', 'not_a_module.txt'])
    @patch('utils.loader.load_module_from_file')
    def test_load_modules_from_directory(self, mock_load_module_from_file, mock_listdir):
        """
